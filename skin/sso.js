...
var ssoOptions=ssoOptions||{logging:true, callbackUri:mw.config.get("wgArticlePath").replace('$1', 'Special:AccountsHandler/callback')};
 ...
 *
 * [0]: https://github.com/webplatform/www.webplatform.org/blob/master/src/files/assets/js/sso.js
 *
 */
